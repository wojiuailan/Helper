...
public class GetFamilyGPS {

    public GetFamilyGPS(final String username, final String token, final String familyName, final Config.SuccessCallback success, final Config.FailCallback fail) {
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    String msg = Config.ACTION + "=" + Config.ACTION_GET_GPS + "&" + Config.USERNAME + "=" + username + "&" + Config.TOKEN + "=" + token + "&" + Config.FAMILY_NAME + "=" + familyName;
